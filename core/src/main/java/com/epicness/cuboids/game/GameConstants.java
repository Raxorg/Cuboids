...
public class GameConstants {
    ...
    public static final float[] BOTTOM_RIGHT_VERTS = {50f, 0f, 0f, 0f, 50f, 50f};
    public static final float[] TOP_VERTS = {25f, 50f, 0f, 0f, 50f, 0f};
    public static final float[] BOTTOM_VERTS = {25f, 0f, 0f, 50f, 50f, 50f};
    public static final float[] LEFT_VERTS = {0f, 25f, 50f, 50f, 50f, 0f};
    public static final float[] RIGHT_VERTS = {50f, 25f, 0f, 0f, 0f, 50f};
