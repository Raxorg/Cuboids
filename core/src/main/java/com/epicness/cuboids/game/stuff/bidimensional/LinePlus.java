...
public class LinePlus extends Fadeable implements Movable, ShapeDrawable {

    private final Line line;

    public LinePlus(float ax, float ay, float bx, float by, float thickness, Color color) {
